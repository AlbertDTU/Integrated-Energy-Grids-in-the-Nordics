...
plt.tight_layout()
plt.savefig("part_d/1d_capacities.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("part_d/1d_total_capacities.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig('part_d/1d_annual_generation_mix.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('part_d/1d_duration_curve.png', dpi=300)
plt.show()